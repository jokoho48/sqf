...
EXPRESSIONS = [
    ...
    UnaryExpression(Keyword('hashvalue'), Object, String),
    UnaryExpression(Keyword('hashvalue'), Side, String),
    ...
    BinaryExpression(Group, Keyword('geteventhandlerinfo'), Array, Array),
    ...
    BinaryExpression(Object, Keyword('getunittrait'), String, Boolean),
    ...
    BinaryExpression(Object, Keyword('lockedcamerato'), Array, Object),
