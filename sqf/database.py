...
EXPRESSIONS = [
    ...
    UnaryExpression(Keyword('ctrltextcolor'), Control, Number),
    ...
    UnaryExpression(Keyword('diag_getterrainheight'), Array, Nothing),
    UnaryExpression(Keyword('diag_getterrainsegmentoffset'), Array, Nothing),
    ...
    UnaryExpression(Keyword('ropesegments'), Object, Object),
    ...
    UnaryExpression(Keyword('toarray'), HashMap, HashMap),
    ...
    BinaryExpression(Array, Keyword('diag_setterrainheight'), Number, Nothing),
    ...
    NullExpression(Keyword('apertureparams'), Boolean),
    ...
    NullExpression(Keyword('diag_getterraingrid'), Array),
