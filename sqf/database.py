...
EXPRESSIONS = [
    ...
    UnaryExpression(Keyword('action'), Array, Nothing),
    UnaryExpression(Keyword('actionids'), Object, Array),
    UnaryExpression(Keyword('actionkeys'), String, Array),
    UnaryExpression(Keyword('actionkeys'), Array, Array),
    UnaryExpression(Keyword('actionkeysex'), String, Array),
    ...
    UnaryExpression(Keyword('activetitleeffectparams'), Number, Array),
    ...
    UnaryExpression(Keyword('addcuratorselected'), Array, Nothing),
    ...
    UnaryExpression(Keyword('adduseractioneventhandler'), Array, Number),
    ...
    UnaryExpression(Keyword('airportside'), Object, Side),
    UnaryExpression(Keyword('airportside'), Number, Side),
    ...
    UnaryExpression(Keyword('allcontrols'), Control, Array),
    UnaryExpression(Keyword('alldiarysubjects'), Object, Array),
    UnaryExpression(Keyword('alllods'), Object, Array),
    UnaryExpression(Keyword('alllods'), String, Array),
    UnaryExpression(Keyword('allmissionobjects'), String, Array),
    UnaryExpression(Keyword('allowedservice'), Object, Number),
    ...
    UnaryExpression(Keyword('allvariables'), Display, Array),
    ...
    UnaryExpression(Keyword('angularvelocity'), Object, Array),
    UnaryExpression(Keyword('angularvelocitymodelspace'), Object, Array),
    ...
    UnaryExpression(Keyword('assignedvehicles'), Group, Array),
    ...
    UnaryExpression(Keyword('candeployweapon'), Object, Boolean),
    ...
    UnaryExpression(Keyword('collisiondisabledwith'), Object, Array),
    UnaryExpression(Keyword('combatbehaviour'), Object, String),
    UnaryExpression(Keyword('combatbehaviour'), Group, String),
    ...
    UnaryExpression(Keyword('compatibleitems'), String, Array),
    UnaryExpression(Keyword('compatibleitems'), Array, Array),
    UnaryExpression(Keyword('compatiblemagazines'), String, Array),
    UnaryExpression(Keyword('compatiblemagazines'), Array, Array),
    UnaryExpression(Keyword('compile'), String, Code),
    UnaryExpression(Keyword('compilefinal'), Code, Code),
    UnaryExpression(Keyword('compilefinal'), String, Code),
    UnaryExpression(Keyword('compilefinal'), HashMap, HashMap),
    UnaryExpression(Keyword('compilescript'), Array, Code),
    ...
    UnaryExpression(Keyword('continuewith'), Type, Anything),
    UnaryExpression(Keyword('conversationdisabled'), Object, Boolean),
    ...
    UnaryExpression(Keyword('createdialog'), Array, Display),
    ...
    UnaryExpression(Keyword('createhashmapfromarray'), Array, HashMap),
    UnaryExpression(Keyword('createhashmapobject'), Array, HashMap),
    ...
    UnaryExpression(Keyword('createsoundsourcelocal'), Array, Object),
    ...
    UnaryExpression(Keyword('createvehiclelocal'), Array, Object),
    ...
    UnaryExpression(Keyword('ctrlbackgroundcolor'), Control, Array),
    ...
    UnaryExpression(Keyword('ctrlfontheight'), Control, Number),
    UnaryExpression(Keyword('ctrlforegroundcolor'), Control, Array),
    ...
    UnaryExpression(Keyword('ctrlmapdir'), Control, Number),
    UnaryExpression(Keyword('ctrlmapmouseover'), Control, Array),
    UnaryExpression(Keyword('ctrlmapposition'), Control, Array),
    ...
    UnaryExpression(Keyword('ctrlmodelvectorside'), Control, Array),
    ...
    UnaryExpression(Keyword('ctrltooltip'), Control, String),
    UnaryExpression(Keyword('ctrltype'), Control, Number),
    UnaryExpression(Keyword('ctrlurl'), Control, String),
    UnaryExpression(Keyword('ctrlurloverlaymode'), Control, Number),
    ...
    UnaryExpression(Keyword('curatorselectionpreset'), Number, Array),
    ...
    UnaryExpression(Keyword('currentvisionmode'), Array, Array),
    ...
    UnaryExpression(Keyword('deletevehicle'), Array, Nothing),
    UnaryExpression(Keyword('deletevehiclecrew'), Object, Nothing),
    ...
    UnaryExpression(Keyword('diag_drawmode'), String, Nothing),
    UnaryExpression(Keyword('diag_dumpscriptassembly'), Code, Nothing),
    UnaryExpression(Keyword('diag_dynamicsimulationend'), String, Nothing),
    UnaryExpression(Keyword('diag_enabled'), String, Boolean),
    UnaryExpression(Keyword('diag_exportconfig'), Array, Nothing),
    UnaryExpression(Keyword('diag_exportterrainsvg'), Array, Nothing),
    UnaryExpression(Keyword('diag_getterrainsegmentoffset'), Array, Array),
    UnaryExpression(Keyword('diag_lightnewload'), String, Nothing),
    UnaryExpression(Keyword('diag_list'), String, Array),
    UnaryExpression(Keyword('diag_localized'), String, Array),
    UnaryExpression(Keyword('diag_log'), Type, Nothing),
    UnaryExpression(Keyword('diag_logslowframe'), Array, Nothing),
    UnaryExpression(Keyword('diag_mergeconfigfile'), Array, Nothing),
    UnaryExpression(Keyword('diag_modifyshape'), Array, Nothing),
    UnaryExpression(Keyword('diag_recordturretlimits'), Boolean, Nothing),
    UnaryExpression(Keyword('diag_remainscollector'), Number, Array),
    UnaryExpression(Keyword('diag_setlightnew'), String, Nothing),
    UnaryExpression(Keyword('diag_sqfcdebugdump'), Array, Nothing),
    UnaryExpression(Keyword('diag_testscriptsimplevm'), Code, String),
    UnaryExpression(Keyword('diag_toggle'), String, Nothing),
    ...
    UnaryExpression(Keyword('difficultyoption'), Array, Array),
    ...
    UnaryExpression(Keyword('displaychild'), Display, Display),
    UnaryExpression(Keyword('displayctrl'), Number, Control),
    UnaryExpression(Keyword('displayparent'), Display, Display),
    UnaryExpression(Keyword('displayuniquename'), Display, String),
    UnaryExpression(Keyword('displayupdate'), Display, Nothing),
    ...
    UnaryExpression(Keyword('drawlaser'), Array, Nothing),
    ...
    UnaryExpression(Keyword('equipmentdisabled'), Object, Array),
    ...
    UnaryExpression(Keyword('execfsm'), Array, Number),
    ...
    UnaryExpression(Keyword('flatten'), Array, Array),
    UnaryExpression(Keyword('fleeing'), Object, Boolean),
    UnaryExpression(Keyword('floor'), Number, Number),
    UnaryExpression(Keyword('focusedctrl'), Display, Control),
    ...
    UnaryExpression(Keyword('forcecadetdifficulty'), Array, Array),
    UnaryExpression(Keyword('forcegeneratorrtd'), Number, Array),
    UnaryExpression(Keyword('forcehitpointsdamagesync'), Object, Boolean),
    UnaryExpression(Keyword('forcemap'), Boolean, Nothing),
    UnaryExpression(Keyword('forcerespawn'), Object, Nothing),
    UnaryExpression(Keyword('forceunicode'), Number, Nothing),
    ...
    UnaryExpression(Keyword('freeextension'), String, Boolean),
    UnaryExpression(Keyword('fromeditor'), TeamMember, Boolean),
    UnaryExpression(Keyword('fromjson'), String, Anything),
    ...
    UnaryExpression(Keyword('gesturestate'), Object, String),
    ...
    UnaryExpression(Keyword('get3dengrid'), String, Number),
    UnaryExpression(Keyword('get3denlayer'), Number, Number),
    UnaryExpression(Keyword('get3denlayer'), Array, Number),
    UnaryExpression(Keyword('get3denlayerentities'), Number, Array),
    UnaryExpression(Keyword('get3denparent'), Number, Anything),
    UnaryExpression(Keyword('get3denparent'), Array, Anything),
    UnaryExpression(Keyword('get3denselected'), String, Array),
    UnaryExpression(Keyword('getaimingcoef'), Object, Number),
    UnaryExpression(Keyword('getallenv3dsoundcontrollers'), Object, Array),
    ...
    UnaryExpression(Keyword('getbonenames'), Object, Array),
    ...
    UnaryExpression(Keyword('getconnecteduavunit'), Object, Object),
    UnaryExpression(Keyword('getcontainermaxload'), String, Number),
    UnaryExpression(Keyword('getcorpse'), Object, Object),
    UnaryExpression(Keyword('getcorpseweaponholders'), Object, Array),
    UnaryExpression(Keyword('getcruisecontrol'), Object, Array),
    ...
    UnaryExpression(Keyword('getdebriefingtext'), String, Array),
    ...
    UnaryExpression(Keyword('getentityinfo'), Object, Array),
    UnaryExpression(Keyword('geteventhandlerinfo'), Array, Array),
    ...
    UnaryExpression(Keyword('getforcedspeed'), Object, Number),
    UnaryExpression(Keyword('getfuelcargo'), Object, Number),
    UnaryExpression(Keyword('getfuelconsumptioncoef'), Object, Number),
    ...
    UnaryExpression(Keyword('getleaning'), Object, Number),
    ...
    UnaryExpression(Keyword('getobjectid'), Object, String),
    UnaryExpression(Keyword('getobjectmaterials'), Object, Array),
    UnaryExpression(Keyword('getobjectscale'), Object, Number),
    ...
    UnaryExpression(Keyword('getphysicscollisionflag'), Object, Array),
    UnaryExpression(Keyword('getpilotcameradirection'), Object, Array),
    UnaryExpression(Keyword('getpilotcameraopticsmode'), Object, Number),
    ...
    UnaryExpression(Keyword('getplayerid'), Object, String),
    ...
    UnaryExpression(Keyword('getrespawnvehicleinfo'), Object, Array),
    UnaryExpression(Keyword('getroadinfo'), Object, Array),
    UnaryExpression(Keyword('getrotorbrakertd'), Object, Number),
    UnaryExpression(Keyword('getsensortargets'), Object, Array),
    UnaryExpression(Keyword('getsensorthreats'), Object, Array),
    UnaryExpression(Keyword('getshotinfo'), Object, Array),
    ...
    UnaryExpression(Keyword('getterrainheight'), Array, Number),
    UnaryExpression(Keyword('getterrainheightasl'), Array, Number),
    UnaryExpression(Keyword('gettext'), Config, String),
    UnaryExpression(Keyword('gettextraw'), Config, String),
    UnaryExpression(Keyword('gettextureinfo'), String, Array),
    UnaryExpression(Keyword('gettowparent'), Object, Object),
    UnaryExpression(Keyword('gettrimoffsetrtd'), Object, Array),
    UnaryExpression(Keyword('getturretopticsmode'), Object, Array),
    UnaryExpression(Keyword('getunitfreefallinfo'), Object, Array),
    ...
    UnaryExpression(Keyword('getunitmovesinfo'), Object, Array),
    UnaryExpression(Keyword('getunloadincombat'), Object, Array),
    UnaryExpression(Keyword('getuserinfo'), String, Array),
    ...
    UnaryExpression(Keyword('getwaterfillpercentage'), Object, Number),
    UnaryExpression(Keyword('getwaterleakiness'), Object, Number),
    ...
    UnaryExpression(Keyword('groupid'), Object, Number),
    UnaryExpression(Keyword('groupowner'), Group, Number),
    UnaryExpression(Keyword('groups'), Side, Array),
    ...
    UnaryExpression(Keyword('hascustomface'), Object, Boolean),
    UnaryExpression(Keyword('hashvalue'), Number, String),
    UnaryExpression(Keyword('hashvalue'), Boolean, String),
    ...
    UnaryExpression(Keyword('ignore3denhistory'), Code, Nothing),
    UnaryExpression(Keyword('image'), String, String),
    UnaryExpression(Keyword('import'), String, Nothing),
    UnaryExpression(Keyword('import'), Array, Nothing),
    ...
    UnaryExpression(Keyword('inputcontroller'), Number, Number),
    UnaryExpression(Keyword('inputmouse'), Number, Number),
    UnaryExpression(Keyword('inputmouse'), String, Boolean),
    UnaryExpression(Keyword('insidebuilding'), Object, Number),
    ...
    UnaryExpression(Keyword('isaisteeringcomponentenabled'), Object, Boolean),
    UnaryExpression(Keyword('isallowedcrewinimmobile'), Object, Boolean),
    ...
    UnaryExpression(Keyword('isawake'), Object, Boolean),
    ...
    UnaryExpression(Keyword('isfinal'), Type, Boolean),
    ...
    UnaryExpression(Keyword('isnull'), TeamMember, Boolean),
    ...
    UnaryExpression(Keyword('isplayer'), Array, Boolean),
    UnaryExpression(Keyword('isrealtime'), Control, Boolean),
    UnaryExpression(Keyword('isremotecontrolling'), Object, Boolean),
    ...
    UnaryExpression(Keyword('isthrowable'), String, Boolean),
    ...
    UnaryExpression(Keyword('isweapondeployed'), Array, Boolean),
    ...
    UnaryExpression(Keyword('keyimage'), String, String),
    UnaryExpression(Keyword('keyimage'), Number, String),
    UnaryExpression(Keyword('keyname'), String, String),
    UnaryExpression(Keyword('keyname'), Number, String),
    UnaryExpression(Keyword('keys'), HashMap, Array),
    ...
    UnaryExpression(Keyword('lbtooltip'), Array, String),
    ...
    UnaryExpression(Keyword('load3denscenario'), String, Boolean),
    UnaryExpression(Keyword('loadabs'), Object, Number),
    UnaryExpression(Keyword('loadbackpack'), Object, Number),
    UnaryExpression(Keyword('loadconfig'), String, Config),
    UnaryExpression(Keyword('loadcuratorselectionpreset'), Number, Nothing),
    ...
    UnaryExpression(Keyword('magazinesallturrets'), Array, Array),
    ...
    UnaryExpression(Keyword('markerchannel'), String, String),
    UnaryExpression(Keyword('markercolor'), String, String),
    UnaryExpression(Keyword('markerdir'), String, Number),
    UnaryExpression(Keyword('markerdrawpriority'), String, Number),
    UnaryExpression(Keyword('markerpolyline'), String, Array),
    UnaryExpression(Keyword('markerpos'), String, Array),
    UnaryExpression(Keyword('markerpos'), Array, Array),
    UnaryExpression(Keyword('markershadow'), String, Boolean),
    ...
    UnaryExpression(Keyword('maxload'), Object, Number),
    ...
    UnaryExpression(Keyword('menusetshortcut'), Array, Nothing),
    UnaryExpression(Keyword('menusettext'), Array, Nothing),
    UnaryExpression(Keyword('menuseturl'), Array, Nothing),
    ...
    UnaryExpression(Keyword('missilestate'), Object, Array),
    ...
    UnaryExpression(Keyword('name'), Namespace, String),
    ...
    UnaryExpression(Keyword('nearestmines'), Array, Array),
    ...
    UnaryExpression(Keyword('needservice'), Object, Array),
    ...
    UnaryExpression(Keyword('opengps'), Boolean, Boolean),
    ...
    UnaryExpression(Keyword('playsound3d'), Array, Number),
    UnaryExpression(Keyword('playsoundui'), Array, Number),
    UnaryExpression(Keyword('pose'), Object, String),
    ...
    UnaryExpression(Keyword('ppeffectenabled'), String, Boolean),
    ...
    UnaryExpression(Keyword('remotecontrolled'), Object, Object),
    UnaryExpression(Keyword('remoteexec'), Array, String),
    UnaryExpression(Keyword('remoteexeccall'), Array, String),
    ...
    UnaryExpression(Keyword('removeallassigneditems'), Array, Nothing),
    UnaryExpression(Keyword('removeallbinocularitems'), Object, Nothing),
    ...
    UnaryExpression(Keyword('removeallsecondaryweaponitems'), Object, Nothing),
    UnaryExpression(Keyword('removealluseractioneventhandlers'), Array, Nothing),
    ...
    UnaryExpression(Keyword('removeuseractioneventhandler'), Array, Nothing),
    ...
    UnaryExpression(Keyword('reverse'), String, String),
    ...
    UnaryExpression(Keyword('ropesattachedto'), Object, Array),
    UnaryExpression(Keyword('ropesegments'), Object, Array),
    ...
    UnaryExpression(Keyword('screentoworlddirection'), Array, Array),
    ...
    UnaryExpression(Keyword('selectionposition'), Array, Array),
    ...
    UnaryExpression(Keyword('set3denattachedcursorentity'), HashMap, Nothing),
    ...
    UnaryExpression(Keyword('setcompassdeclination'), Number, Nothing),
    UnaryExpression(Keyword('setcompassoscillation'), Array, Nothing),
    UnaryExpression(Keyword('setcuratorselected'), Array, Nothing),
    ...
    UnaryExpression(Keyword('sethumidity'), Number, Nothing),
    UnaryExpression(Keyword('setinfopanel'), Array, Boolean),
    UnaryExpression(Keyword('setlocalwindparams'), Array, Nothing),
    UnaryExpression(Keyword('setmissionoptions'), HashMap, Nothing),
    ...
    UnaryExpression(Keyword('setpipviewdistance'), Number, Nothing),
    UnaryExpression(Keyword('setplayable'), Object, Nothing),
    UnaryExpression(Keyword('setplayerrespawntime'), Number, Nothing),
    UnaryExpression(Keyword('setrain'), Array, Nothing),
    UnaryExpression(Keyword('setrain'), Config, Nothing),
    ...
    UnaryExpression(Keyword('setterrainheight'), Array, Nothing),
    UnaryExpression(Keyword('settimemultiplier'), Number, Nothing),
    UnaryExpression(Keyword('settiparameter'), Array, Nothing),
    ...
    UnaryExpression(Keyword('simulsethumidity'), Number, Nothing),
    ...
    UnaryExpression(Keyword('soundparams'), Number, Array),
    ...
    UnaryExpression(Keyword('stopsound'), Number, Nothing),
    ...
    UnaryExpression(Keyword('taskname'), Task, String),
    ...
    UnaryExpression(Keyword('terminate'), Number, Nothing),
    ...
    UnaryExpression(Keyword('throwables'), Object, Array),
    ...
    UnaryExpression(Keyword('toarray'), HashMap, Array),
    UnaryExpression(Keyword('tofixed'), Number, Nothing),
    UnaryExpression(Keyword('tojson'), Type, String),
    ...
    UnaryExpression(Keyword('tostring'), Code, String),
    ...
    UnaryExpression(Keyword('trim'), String, String),
    ...
    UnaryExpression(Keyword('tvselection'), Control, Array),
    ...
    UnaryExpression(Keyword('uniqueunititems'), Object, HashMap),
    UnaryExpression(Keyword('uniqueunititems'), Array, HashMap),
    ...
    UnaryExpression(Keyword('unitcombatmode'), Object, String),
    ...
    UnaryExpression(Keyword('units'), Side, Anything),
    ...
    UnaryExpression(Keyword('values'), HashMap, Array),
    ...
    UnaryExpression(Keyword('vectorside'), Object, Array),
    UnaryExpression(Keyword('vectorsidevisual'), Object, Array),
    ...
    UnaryExpression(Keyword('waterdamaged'), Object, Boolean),
    ...
    UnaryExpression(Keyword('weapondisassemblyenabled'), Object, Boolean),
    ...
    UnaryExpression(Keyword('weaponsitems'), Array, Array),
    UnaryExpression(Keyword('weaponsitemscargo'), Object, Array),
    UnaryExpression(Keyword('weaponsitemscargo'), Array, Array),
    ...
    BinaryExpression(Object, Keyword('actionnow'), Array, Nothing),
    ...
    BinaryExpression(Object, Keyword('addbinocularitem'), String, Nothing),
    ...
    BinaryExpression(Group, Keyword('addeventhandler'), Array, Number),
    ...
    BinaryExpression(Object, Keyword('alldiaryrecords'), String, Array),
    BinaryExpression(Number, Keyword('allobjects'), Number, Array),
    BinaryExpression(String, Keyword('allobjects'), Number, Array),
    ...
    BinaryExpression(Object, Keyword('allowcrewinimmobile'), Array, Nothing),
    ...
    BinaryExpression(Object, Keyword('allowservice'), Number, Nothing),
    BinaryExpression(Object, Keyword('allowsprint'), Boolean, Nothing),
    BinaryExpression(Object, Keyword('ammo'), String, Number),
    BinaryExpression(Object, Keyword('ammoonpylon'), String, Anything),
    BinaryExpression(Object, Keyword('ammoonpylon'), Number, Anything),
    ...
    BinaryExpression(HashMap, Keyword('apply'), Code, Array),
    ...
    BinaryExpression(Object, Keyword('awake'), Boolean, Nothing),
    ...
    BinaryExpression(HashMap, Keyword('call'), Array, Anything),
    ...
    BinaryExpression(String, Keyword('canadd'), String, Boolean),
    BinaryExpression(String, Keyword('canadd'), Array, Boolean),
    ...
    BinaryExpression(String, Keyword('canslingload'), String, Boolean),
    ...
    BinaryExpression(Type, Keyword('clear3denattribute'), String, Boolean),
    BinaryExpression(Display, Keyword('closedisplay'), Number, Nothing),
    BinaryExpression(Array, Keyword('collect3denhistory'), Code, Nothing),
    ...
    BinaryExpression(Array, Keyword('createhashmapfromarray'), Array, HashMap),
    ...
    BinaryExpression(Group, Keyword('createvehiclecrew'), Object, Group),
    BinaryExpression(Side, Keyword('createvehiclecrew'), Object, Group),
    ...
    BinaryExpression(Control, Keyword('ctrlactivate'), Boolean, Nothing),
    ...
    BinaryExpression(Display, Keyword('ctrlat'), Array, Control),
    ...
    BinaryExpression(Control, Keyword('ctrlmapsetposition'), Array, Nothing),
    ...
    BinaryExpression(Control, Keyword('ctrlsetmouseposition'), Array, Nothing),
    ...
    BinaryExpression(Control, Keyword('ctrlsetshadow'), Number, Nothing),
    ...
    BinaryExpression(Control, Keyword('ctrlsettooltipmaxwidth'), Number, Number),
    BinaryExpression(Control, Keyword('ctrlseturl'), String, Nothing),
    BinaryExpression(Control, Keyword('ctrlseturloverlaymode'), Number, Nothing),
    BinaryExpression(Control, Keyword('ctrlshow'), Boolean, Nothing),
    BinaryExpression(Control, Keyword('ctrlwebbrowseraction'), Array, Nothing),
    ...
    BinaryExpression(Object, Keyword('currentvisionmode'), Array, Array),
    BinaryExpression(Object, Keyword('currentvisionmode'), String, Array),
    BinaryExpression(Object, Keyword('currentweaponturret'), Array, String),
    BinaryExpression(Object, Keyword('currentzeroing'), Array, Array),
    ...
    BinaryExpression(Array, Keyword('deleteat'), Array, Array),
    BinaryExpression(HashMap, Keyword('deleteat'), Number, Anything),
    BinaryExpression(HashMap, Keyword('deleteat'), Boolean, Anything),
    ...
    BinaryExpression(String, Keyword('diag_enable'), Boolean, Nothing),
    BinaryExpression(Object, Keyword('diarysubjectexists'), String, Boolean),
    BinaryExpression(Object, Keyword('directionstabilizationenabled'), Array, Boolean),
    BinaryExpression(Object, Keyword('directsay'), String, Nothing),
    BinaryExpression(Object, Keyword('disableai'), String, Nothing),
    BinaryExpression(Object, Keyword('disablebrakes'), Boolean, Nothing),
    ...
    BinaryExpression(Number, Keyword('distance'), Number, Number),
    ...
    BinaryExpression(Number, Keyword('distancesqr'), Number, Number),
    ...
    BinaryExpression(Object, Keyword('enableaudiofeature'), Array, Boolean),
    ...
    BinaryExpression(Object, Keyword('enabledirectionstabilization'), Array, Nothing),
    ...
    BinaryExpression(Type, Keyword('execfsm'), Array, Number),
    BinaryExpression(Type, Keyword('execvm'), String, Script),
    BinaryExpression(IfType, Keyword('exitwith'), Code, Anything),
    BinaryExpression(Number, Keyword('fadeenvironment'), Number, Nothing),
    ...
    BinaryExpression(String, Keyword('find'), Array, Number),
    BinaryExpression(Array, Keyword('findany'), Array, Number),
    ...
    BinaryExpression(Object, Keyword('flyinheight'), Array, Nothing),
    ...
    BinaryExpression(Code, Keyword('foreach'), HashMap, Anything),
    ...
    BinaryExpression(Code, Keyword('foreachreversed'), Array, Nothing),
    ...
    BinaryExpression(Number, Keyword('get3denattributes'), String, Array),
    BinaryExpression(Array, Keyword('get3denattributes'), String, Array),
    BinaryExpression(String, Keyword('get3denmissionattribute'), String, Anything),
    BinaryExpression(String, Keyword('get3denmissionattributes'), String, Array),
    ...
    BinaryExpression(Object, Keyword('getdirvisual'), Object, Number),
    BinaryExpression(Object, Keyword('getdirvisual'), Array, Number),
    BinaryExpression(Array, Keyword('getdirvisual'), Object, Number),
    BinaryExpression(Array, Keyword('getdirvisual'), Array, Number),
    BinaryExpression(Control, Keyword('geteditorobjectscope'), String, String),
    BinaryExpression(Object, Keyword('getentityinfo'), Number, Anything),
    BinaryExpression(Object, Keyword('getenv3dsoundcontroller'), String, Number),
    BinaryExpression(Array, Keyword('getenvsoundcontroller'), String, Number),
    BinaryExpression(Control, Keyword('geteventhandlerinfo'), Array, Array),
    BinaryExpression(Object, Keyword('geteventhandlerinfo'), Array, Array),
    ...
    BinaryExpression(Object, Keyword('getopticsmode'), Number, String),
    BinaryExpression(HashMap, Keyword('getordefault'), Array, Anything),
    BinaryExpression(HashMap, Keyword('getordefaultcall'), Array, Anything),
    ...
    BinaryExpression(Object, Keyword('getrelpos'), Object, Array),
    BinaryExpression(Object, Keyword('getrespawnvehicleinfo'), Number, Anything),
    BinaryExpression(Object, Keyword('getselectionbones'), Array, Array),
    BinaryExpression(Object, Keyword('getshotinfo'), Number, Anything),
    BinaryExpression(Object, Keyword('getslotitemname'), Number, String),
    ...
    BinaryExpression(Object, Keyword('getturretlimits'), Array, Array),
    BinaryExpression(Object, Keyword('getturretopticsmode'), Array, Nothing),
    BinaryExpression(Object, Keyword('getunitmovesinfo'), Number, Anything),
    BinaryExpression(Object, Keyword('getunittrait'), String, Anything),
    BinaryExpression(String, Keyword('getuserinfo'), Number, Anything),
    ...
    BinaryExpression(Object, Keyword('ignoretarget'), Object, Nothing),
    BinaryExpression(Object, Keyword('ignoretarget'), Array, Nothing),
    BinaryExpression(Group, Keyword('ignoretarget'), Object, Nothing),
    BinaryExpression(Group, Keyword('ignoretarget'), Array, Nothing),
    ...
    BinaryExpression(Array, Keyword('inareaarrayindexes'), Object, Array),
    BinaryExpression(Array, Keyword('inareaarrayindexes'), String, Array),
    BinaryExpression(Array, Keyword('inareaarrayindexes'), Array, Array),
    BinaryExpression(Array, Keyword('inareaarrayindexes'), Location, Array),
    ...
    BinaryExpression(Object, Keyword('islaseron'), Array, Boolean),
    BinaryExpression(Object, Keyword('isnil'), String, Boolean),
    BinaryExpression(Group, Keyword('isnil'), String, Boolean),
    BinaryExpression(Namespace, Keyword('isnil'), String, Boolean),
    BinaryExpression(HashMap, Keyword('isnil'), String, Boolean),
    BinaryExpression(Type, Keyword('isnotequalref'), Type, Boolean),
    BinaryExpression(Type, Keyword('isnotequalto'), Type, Boolean),
    ...
    BinaryExpression(Object, Keyword('landat'), Array, Boolean),
    BinaryExpression(Object, Keyword('lasertarget'), Array, Object),
    ...
    BinaryExpression(Control, Keyword('lbsortby'), Array, Nothing),
    BinaryExpression(Number, Keyword('lbsortby'), Array, Nothing),
    BinaryExpression(Control, Keyword('lbtext'), Number, String),
    BinaryExpression(Control, Keyword('lbtextright'), Number, String),
    BinaryExpression(Control, Keyword('lbtooltip'), Number, String),
    ...
    BinaryExpression(Array, Keyword('lnbsortby'), Array, Nothing),
    ...
    BinaryExpression(Object, Keyword('lockedcamerato'), Array, Array),
    ...
    BinaryExpression(Control, Keyword('mapcenteroncamera'), Boolean, Array),
    ...
    BinaryExpression(Control, Keyword('menusetshortcut'), Array, Nothing),
    BinaryExpression(Control, Keyword('menusettext'), Array, Nothing),
    BinaryExpression(Control, Keyword('menuseturl'), Array, Nothing),
    ...
    BinaryExpression(HashMap, Keyword('merge'), HashMap, Nothing),
    BinaryExpression(HashMap, Keyword('merge'), Array, Nothing),
    ...
    BinaryExpression(Object, Keyword('moveout'), Object, Nothing),
    BinaryExpression(Object, Keyword('moveto'), Array, Nothing),
    BinaryExpression(Object, Keyword('namedproperties'), Array, HashMap),
    ...
    BinaryExpression(String, Keyword('nearentities'), Array, Array),
    ...
    BinaryExpression(String, Keyword('regexfind'), Array, Array),
    BinaryExpression(String, Keyword('regexmatch'), String, Boolean),
    BinaryExpression(String, Keyword('regexreplace'), Array, String),
    BinaryExpression(TeamMember, Keyword('registertask'), String, Boolean),
    BinaryExpression(Object, Keyword('reload'), Array, Boolean),
    BinaryExpression(Object, Keyword('remotecontrol'), Object, Nothing),
    BinaryExpression(Type, Keyword('remoteexec'), Array, String),
    BinaryExpression(Type, Keyword('remoteexeccall'), Array, String),
    ...
    BinaryExpression(Group, Keyword('removealleventhandlers'), String, Nothing),
    BinaryExpression(Object, Keyword('removeallmpeventhandlers'), String, Nothing),
    BinaryExpression(Object, Keyword('removebinocularitem'), String, Nothing),
    ...
    BinaryExpression(Group, Keyword('removeeventhandler'), Array, Nothing),
    ...
    BinaryExpression(Array, Keyword('resize'), Array, Nothing),
    ...
    BinaryExpression(Object, Keyword('ropeattachto'), Object, Nothing),
    ...
    BinaryExpression(Object, Keyword('screentoworld'), Array, Array),
    BinaryExpression(Object, Keyword('screentoworlddirection'), Array, Array),
    ...
    BinaryExpression(Object, Keyword('selectdiarysubject'), String, Boolean),
    ...
    BinaryExpression(Object, Keyword('selectionvectordirandup'), Array, Array),
    ...
    BinaryExpression(Object, Keyword('selectthrowable'), String, Boolean),
    BinaryExpression(Object, Keyword('selectweapon'), String, Nothing),
    BinaryExpression(Object, Keyword('selectweapon'), Array, Boolean),
    ...
    BinaryExpression(HashMap, Keyword('set'), Array, Boolean),
    ...
    BinaryExpression(Object, Keyword('setangularvelocity'), Array, Nothing),
    BinaryExpression(Object, Keyword('setangularvelocitymodelspace'), Array, Nothing),
    ...
    BinaryExpression(String, Keyword('setattributes'), Array, String),
    BinaryExpression(Object, Keyword('setautonomous'), Boolean, Boolean),
    ...
    BinaryExpression(Object, Keyword('setcombatbehaviour'), String, Nothing),
    BinaryExpression(Group, Keyword('setcombatbehaviour'), String, Nothing),
    ...
    BinaryExpression(Object, Keyword('setcruisecontrol'), Array, Nothing),
    ...
    BinaryExpression(Number, Keyword('setcuratorselectionpreset'), Array, Nothing),
    ...
    BinaryExpression(Object, Keyword('setdiarysubjectpicture'), Array, Nothing),
    ...
    BinaryExpression(Object, Keyword('setfuelconsumptioncoef'), Number, Nothing),
    ...
    BinaryExpression(Object, Keyword('setlightconepars'), Array, Nothing),
    ...
    BinaryExpression(Object, Keyword('setlightir'), Boolean, Nothing),
    ...
    BinaryExpression(Object, Keyword('setlightvolumeshape'), Array, Nothing),
    ...
    BinaryExpression(String, Keyword('setmarkerdrawpriority'), Number, Nothing),
    BinaryExpression(String, Keyword('setmarkerpolyline'), Array, Nothing),
    BinaryExpression(String, Keyword('setmarkerpolylinelocal'), Array, Nothing),
    ...
    BinaryExpression(String, Keyword('setmarkershadow'), Boolean, Nothing),
    BinaryExpression(String, Keyword('setmarkershadowlocal'), Boolean, Nothing),
    ...
    BinaryExpression(Object, Keyword('setmaxload'), Number, Nothing),
    BinaryExpression(Object, Keyword('setmimic'), String, Nothing),
    BinaryExpression(Object, Keyword('setmissiletarget'), Object, Boolean),
    BinaryExpression(Object, Keyword('setmissiletarget'), Array, Boolean),
    ...
    BinaryExpression(Object, Keyword('setobjectscale'), Number, Nothing),
    ...
    BinaryExpression(Object, Keyword('setopticsmode'), Array, Nothing),
    BinaryExpression(Object, Keyword('setopticsmode'), String, Nothing),
    ...
    BinaryExpression(Object, Keyword('setphysicscollisionflag'), Boolean, Nothing),
    BinaryExpression(Object, Keyword('setpilotcameradirection'), Array, Nothing),
    BinaryExpression(Object, Keyword('setpilotcameraopticsmode'), Number, Boolean),
    ...
    BinaryExpression(Object, Keyword('settowparent'), Object, Nothing),
    ...
    BinaryExpression(Object, Keyword('setturretlimits'), Array, Nothing),
    BinaryExpression(Object, Keyword('setturretopticsmode'), Number, Nothing),
    BinaryExpression(Object, Keyword('setturretopticsmode'), Array, Nothing),
    ...
    BinaryExpression(Object, Keyword('setunitcombatmode'), String, Nothing),
    BinaryExpression(Object, Keyword('setunitfreefallheight'), Number, Nothing),
    ...
    BinaryExpression(Object, Keyword('setwaterfillpercentage'), Number, Nothing),
    BinaryExpression(Object, Keyword('setwaterleakiness'), Number, Nothing),
    ...
    BinaryExpression(Object, Keyword('setweaponzeroing'), Array, Boolean),
    ...
    BinaryExpression(Object, Keyword('switchgesture'), Array, Nothing),
    BinaryExpression(Object, Keyword('switchlight'), String, Nothing),
    BinaryExpression(Object, Keyword('switchmove'), String, Nothing),
    BinaryExpression(Object, Keyword('switchmove'), Array, Nothing),
    ...
    BinaryExpression(Group, Keyword('targets'), Array, Array),
    ...
    BinaryExpression(HashMap, Keyword('toarray'), Boolean, Array),
    ...
    BinaryExpression(String, Keyword('trim'), Array, String),
    ...
    BinaryExpression(Control, Keyword('tvisselected'), Array, Boolean),
    ...
    BinaryExpression(Control, Keyword('tvsetselected'), Array, Nothing),
    ...
    BinaryExpression(Control, Keyword('tvsortall'), Array, Nothing),
    BinaryExpression(Control, Keyword('tvsortbyvalue'), Array, Nothing),
    BinaryExpression(Control, Keyword('tvsortbyvalueall'), Array, Nothing),
    ...
    BinaryExpression(Object, Keyword('useaisteeringcomponent'), Boolean, Nothing),
    ...
    BinaryExpression(Array, Keyword('vectormultiply'), Array, Array),
    ...
    BinaryExpression(Object, Keyword('weaponreloadingtime'), Array, Number),
    BinaryExpression(Object, Keyword('weaponsinfo'), Array, Array),
    BinaryExpression(Object, Keyword('weaponstate'), String, Array),
    ...
    BinaryExpression(Object, Keyword('worldtoscreen'), Array, Array),
    ...
    NullExpression(Keyword('allcameras'), Array),
    ...
    NullExpression(Keyword('allenv3dsoundsources'), Array),
    NullExpression(Keyword('allextensions'), Array),
    ...
    NullExpression(Keyword('allusers'), Array),
    NullExpression(Keyword('ambienttemperature'), Array),
    NullExpression(Keyword('apertureparams'), Array),
    NullExpression(Keyword('armorypoints'), Number),
    NullExpression(Keyword('benchmark'), Number),
    NullExpression(Keyword('blufor'), Side),
    NullExpression(Keyword('break'), Nothing),
    ...
    NullExpression(Keyword('diag_dumpcalltracetolog'), Boolean),
    NullExpression(Keyword('diag_dumpterrainsynth'), Array),
    ...
    NullExpression(Keyword('diag_resetanims'), Nothing),
    NullExpression(Keyword('diag_resetfsm'), Nothing),
    NullExpression(Keyword('diag_resetshapes'), Nothing),
    NullExpression(Keyword('diag_scope'), Number),
    NullExpression(Keyword('diag_stacktrace'), Array),
    ...
    NullExpression(Keyword('environmentvolume'), Number),
    ...
    NullExpression(Keyword('focuson'), Object),
    ...
    NullExpression(Keyword('getmissionoptions'), HashMap),
    ...
    NullExpression(Keyword('getpipviewdistance'), Number),
    ...
    NullExpression(Keyword('getterraininfo'), Array),
    NullExpression(Keyword('gettiparameters'), HashMap),
    NullExpression(Keyword('gettotaldlcusagetime'), Number),
    NullExpression(Keyword('getvideooptions'), HashMap),
    ...
    NullExpression(Keyword('ismissionprofilenamespaceloaded'), Boolean),
    ...
    NullExpression(Keyword('issaving'), Boolean),
    NullExpression(Keyword('isserver'), Boolean),
    NullExpression(Keyword('issteammission'), Boolean),
    NullExpression(Keyword('issteamoverlayenabled'), Boolean),
    ...
    NullExpression(Keyword('isusingaisteeringcomponent'), Boolean),
    ...
    NullExpression(Keyword('missionend'), Array),
    NullExpression(Keyword('missionname'), String),
    NullExpression(Keyword('missionnamesource'), String),
    NullExpression(Keyword('missionnamespace'), Namespace, action=lambda i: 'missionNamespace'),
    NullExpression(Keyword('missionprofilenamespace'), Namespace, action=lambda i: 'missionNamespace'),
    ...
    NullExpression(Keyword('mtjobtest'), Boolean),
    ...
    NullExpression(Keyword('playertargetlock'), Array),
    NullExpression(Keyword('privateall'), Nothing),
    ...
    NullExpression(Keyword('radioenabled'), Boolean),
    NullExpression(Keyword('radiovolume'), Number),
    NullExpression(Keyword('rain'), Number),
    NullExpression(Keyword('rainbow'), Number),
    NullExpression(Keyword('rainparams'), Array),
    NullExpression(Keyword('remoteexecutedjipid'), String),
    ...
    NullExpression(Keyword('save3denpreferences'), Boolean),
    NullExpression(Keyword('savegame'), Nothing),
    NullExpression(Keyword('savejoysticks'), Nothing),
    NullExpression(Keyword('savemissionprofilenamespace'), Boolean),
    ...
    NullExpression(Keyword('sentencesenabled'), Boolean),
    NullExpression(Keyword('servername'), String),
    NullExpression(Keyword('servernamespace'), Namespace, action=lambda i: 'missionNamespace'),
    ...
    NullExpression(Keyword('shownsubtitles'), Boolean),
    ...
    NullExpression(Keyword('speechvolume'), Number),
