...
EXPRESSIONS = [
	...
	NullExpression(Keyword('admin'), Number),
	...
	UnaryExpression(Keyword('ctClear'), Control, Array),
	UnaryExpression(Keyword('ctCurSel'), Control, Number),
	UnaryExpression(Keyword('ctData'), Control, String),
	...
	BinaryExpression(Control, Keyword('ctSetData'), Number, Nothing),
	BinaryExpression(Control, Keyword('ctSetValue'), Number, Nothing),
	...
	UnaryExpression(Keyword('ctValue'), Control, Number),
	UnaryExpression(Keyword('ctClear'), Control, Array),
	UnaryExpression(Keyword('ctClear'), Control, Array),
	UnaryExpression(Keyword('ctClear'), Control, Array),
]
